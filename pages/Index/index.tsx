...
const IndexPage: NextPage = () => {
  return (
    <React.Fragment>
      <Layout title="Home | Next.js + TypeScript Example" container={false} >
        <Hero />
        ...
        <div className="container">
          ...
          <div className="techstack-container">
            <TechStackCard heading="Languages and Frameworks" items={["C#", "JavaScript", "HTML", "CSS", "Sass", "jQuery", "React", "NextJS"]} />
            <TechStackCard heading="Tools" items={["SQL Server", "MySQL", "InfluxDB", "SQLite", "Episerver", "Umbraco", "Azure", "Azure DevOps", "Docker", "Ubuntu Server"]} />
          </div>
        </div>
      </Layout>
    </React.Fragment>
